...
```
helm install my-abcdesktop abcdesktop/abcdesktop --version 4.4.13 --create-namespace -n abcdesktop
```
...
Successfully packaged chart and saved it to: abcdesktop-4.4.13.tgz
~~~

The helm file **abcdesktop-4.4.13.tgz** is created.

Let's lint it:

~~~ bash
$ helm lint abcdesktop-4.4.13.tgz
==> Linting abcdesktop-4.4.13.tgz
...
abcdesktop/abcdesktop	4.4.13        	4.4.13      	ABCDesktop helm chart
~~~
...
~~~ bash
$ helm upgrade --install abcdesktop --create-namespace ./abcdesktop-4.4.13.tgz  -n abcdesktop
~~~
...
`
helm install --set openldap.enabled=false my-abcdesktop abcdesktop/abcdesktop --version 4.4.13 --create-namespace -n abcdesktop
`
